    ...
    <StyledWrapper>
      <div className="card">
        ...
        <div className="content">
          ...
          <span className="logo-bottom-text">David Carbajal</span>
        </div>
        <span className="bottom-text">Experto en Hacking</span>
      </div>
    </StyledWrapper>
  );
}
...
const StyledWrapper = styled.div`
  ...
  @keyframes trail {
    0% {
      background: linear-gradient(90deg, rgba(66, 153, 225, 0) 90%, rgb(66, 153, 225) 100%);
      opacity: 0;
    }

    30% {
      background: linear-gradient(90deg, rgba(66, 153, 225, 0) 70%, rgb(66, 153, 225) 100%);
      opacity: 1;
    }
...
export default DavidCarbajalCard;
